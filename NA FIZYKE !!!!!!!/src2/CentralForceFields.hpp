...
namespace CentralForceFields {
  ...
  inline void Render() {
      Vector2 centerMass = {400,300};

      PointMass body1 = { { centerMass.x - 100, centerMass.y }, { 0, 0 }, 10.0f }; // First body
      PointMass body2 = { { centerMass.x + 100, centerMass.y }, { 0, 0 }, 10.0f }; // Second body
